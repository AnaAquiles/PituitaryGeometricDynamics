...
Before diving in, let’s set up a reproducible computational environment.

- `environment.yml` → defines all required dependencies  

You can create and activate it with:
